...
_p9k_restore_state_impl () {
	...
	typeset -g -a _p9k_t=($'\n' $'%{\n%}' '' $'\n' '%b%K{238}%f${(pl.${$((_p9k__clm-_p9k__ind))/#-*/0}..─.)}%k%f${_p9k_t[$((1+!_p9k__ind))]}' '${${:-${_p9k__x::=0}${_p9k__y::=1024}${_p9k__p::=$_p9k__lprompt$_p9k__rprompt}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$(((_p9k__x+_p9k__y)/2))}${_p9k__xy::=${${(%):-$_p9k__p%$_p9k__m(l./$_p9k__m;$_p9k__y./$_p9k__x;$_p9k__m)}##*/}}${_p9k__x::=${_p9k__xy%;*}}${_p9k__y::=${_p9k__xy#*;}}${_p9k__m::=$((_p9k__clm-_p9k__x-_p9k__ind-1))}}+}' $'${${_p9k__clm::=$COLUMNS}+}${${COLUMNS::=1024}+}${${_p9k__keymap::=${KEYMAP:-$_p9k__keymap}}+}${${_p9k__zle_state::=${ZLE_STATE:-$_p9k__zle_state}}+}%b%k%f${${_p9k__ind::=${${ZLE_RPROMPT_INDENT:-1}/#-*/0}}+}${_p9k_t[${_p9k__empty_line_i:-4}]}%{${_p9k__ipe-${_p9k_t[${_p9k__ruler_i:-1}]:+\n${(Q)${:-"$\'\\\\033\'\\\\[A"}}}}%}${(e)_p9k_t[${_p9k__ruler_i:-5}]}' '%b%k%F{238}%b%K{238}%F{070} ' '<_p9k__w>%b%K{238}%F{070}' '<_p9k__w>%b%K{238}%F{070}%246F╱%b%K{238}%F{070} ' '<_p9k__w>%F{238}%b%K{238}%F{070} ' '%b%k%F{238}%b%K{238}%F{037} ' '<_p9k__w>%b%K{238}%F{037}' '<_p9k__w>%b%K{238}%F{037}%246F╱%b%K{238}%F{037} ' '<_p9k__w>%F{238}%b%K{238}%F{037} ' '%b%k%F{238}%b%K{238}%F{180} ' '<_p9k__w>%b%K{238}%F{180}' '<_p9k__w>%b%K{238}%F{180}%246F╱%b%K{238}%F{180} ' '<_p9k__w>%F{238}%b%K{238}%F{180} ' '%b%k%F{238}%b%K{238}%F{178} ' '<_p9k__w>%b%K{238}%F{178}' '<_p9k__w>%b%K{238}%F{178}%246F╱%b%K{238}%F{178} ' '<_p9k__w>%F{238}%b%K{238}%F{178} ' '%b%k%F{238}%b%K{238}%F{172} ' '<_p9k__w>%b%K{238}%F{172}' '<_p9k__w>%b%K{238}%F{172}%246F╱%b%K{238}%F{172} ' '<_p9k__w>%F{238}%b%K{238}%F{172} ' '%b%k%F{238}%b%K{238}%F{106} ' '<_p9k__w>%b%K{238}%F{106}' '<_p9k__w>%b%K{238}%F{106}%246F╱%b%K{238}%F{106} ' '<_p9k__w>%F{238}%b%K{238}%F{106} ' '%b%k%F{238}%b%K{238}%F{068} ' '<_p9k__w>%b%K{238}%F{068}' '<_p9k__w>%b%K{238}%F{068}%246F╱%b%K{238}%F{068} ' '<_p9k__w>%F{238}%b%K{238}%F{068} ' '%b%k%F{238}%b%K{238}%F{066} ' '<_p9k__w>%b%K{238}%F{066}' '<_p9k__w>%b%K{238}%F{066}%246F╱%b%K{238}%F{066} ' '<_p9k__w>%F{238}%b%K{238}%F{066} ' '%b%K{238}%F{031} ' '%b%K{238}%F{031}' '%b%K{238}<_p9k__ss>%b%K{238}%F{031} ' '%b%K{238}<_p9k__s>%b%K{238}%F{031} ' '%b%k%F{238}%b%K{238}%F{178} ' '<_p9k__w>%b%K{238}%F{178}' '<_p9k__w>%b%K{238}%F{178}%246F╱%b%K{238}%F{178} ' '<_p9k__w>%F{238}%b%K{238}%F{178} ' '%b%k%F{238}%b%K{238}%F{178} ' '<_p9k__w>%b%K{238}%F{178}' '<_p9k__w>%b%K{238}%F{178}%246F╱%b%K{238}%F{178} ' '<_p9k__w>%F{238}%b%K{238}%F{178} ' '%b%k%F{238}%b%K{238}%F{178} ' '<_p9k__w>%b%K{238}%F{178}' '<_p9k__w>%b%K{238}%F{178}%246F╱%b%K{238}%F{178} ' '<_p9k__w>%F{238}%b%K{238}%F{178} ' '%b%k%F{238}%b%K{238}%F{072} ' '<_p9k__w>%b%K{238}%F{072}' '<_p9k__w>%b%K{238}%F{072}%246F╱%b%K{238}%F{072} ' '<_p9k__w>%F{238}%b%K{238}%F{072} ' '%b%k%F{238}%b%K{238}%F{072} ' '<_p9k__w>%b%K{238}%F{072}' '<_p9k__w>%b%K{238}%F{072}%246F╱%b%K{238}%F{072} ' '<_p9k__w>%F{238}%b%K{238}%F{072} ' '%b%k%F{238}%b%K{238}%F{072} ' '<_p9k__w>%b%K{238}%F{072}' '<_p9k__w>%b%K{238}%F{072}%246F╱%b%K{238}%F{072} ' '<_p9k__w>%F{238}%b%K{238}%F{072} ' '%b%k%F{238}%b%K{238}%F{034} ' '<_p9k__w>%b%K{238}%F{034}' '<_p9k__w>%b%K{238}%F{034}%246F╱%b%K{238}%F{034} ' '<_p9k__w>%F{238}%b%K{238}%F{034} ' '%b%k%F{238}%b%K{238}%F{178} ' '<_p9k__w>%b%K{238}%F{178}' '<_p9k__w>%b%K{238}%F{178}%246F╱%b%K{238}%F{178} ' '<_p9k__w>%F{238}%b%K{238}%F{178} ' '%b%k%F{238}%b%K{238}%F{074} ' '<_p9k__w>%b%K{238}%F{074}' '<_p9k__w>%b%K{238}%F{074}%246F╱%b%K{238}%F{074} ' '<_p9k__w>%F{238}%b%K{238}%F{074} ' '%b%k%F{238}%b%K{238}%F{033} ' '<_p9k__w>%b%K{238}%F{033}' '<_p9k__w>%b%K{238}%F{033}%246F╱%b%K{238}%F{033} ' '<_p9k__w>%F{238}%b%K{238}%F{033} ' '%b%k%F{238}%b%K{238}%F{160} ' '<_p9k__w>%b%K{238}%F{160}' '<_p9k__w>%b%K{238}%F{160}%246F╱%b%K{238}%F{160} ' '<_p9k__w>%F{238}%b%K{238}%F{160} ' '%b%k%F{238}%b%K{238}%F{248} ' '<_p9k__w>%b%K{238}%F{248}' '<_p9k__w>%b%K{238}%F{248}%246F╱%b%K{238}%F{248} ' '<_p9k__w>%F{238}%b%K{238}%F{248} ' '%b%K{238}%F{076} ' '%b%K{238}%F{076}' '%b%K{238}<_p9k__ss>%b%K{238}%F{076} ' '%b%K{238}<_p9k__s>%b%K{238}%F{076} ' '%b%K{238}%F{076} ' '%b%K{238}%F{076}' '%b%K{238}<_p9k__ss>%b%K{238}%F{076} ' '%b%K{238}<_p9k__s>%b%K{238}%F{076} ' '%b%K{238}%F{076} ' '%b%K{238}%F{076}' '%b%K{238}<_p9k__ss>%b%K{238}%F{076} ' '%b%K{238}<_p9k__s>%b%K{238}%F{076} ' '%b%K{238}%F{178} ' '%b%K{238}%F{178}' '%b%K{238}<_p9k__ss>%b%K{238}%F{178} ' '%b%K{238}<_p9k__s>%b%K{238}%F{178} ') 
	...
	typeset -g -A _p9k_dumped_instant_prompt_sigs=([/Users/valeriy/Projects/speckit-test:0:%]=1) 
